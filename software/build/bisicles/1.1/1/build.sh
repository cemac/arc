...
#
#   svn co https://anag-repo.lbl.gov/svn/BISICLES/public/release/1.1
...
#  bisicles 1.1 : 
#
#    > r3734 | slcornford | 2019-02-01 08:57:17 +0000 (Fri, 01 Feb 2019) | 2 lines
#    > 
#    > release 1.1
#
#  chombo 3.2.patch8:
...
function build_bisicles() {
  ...
  if [ ! -e ${BISICLES_HOME}/BISICLES ] ; then
    ...
    # extract!:
    tar xzf ${SRC_DIR}/bisicles-1.1.tar.gz \
      -C ${BISICLES_HOME}
    \mv ${BISICLES_HOME}/bisicles-1.1 \
