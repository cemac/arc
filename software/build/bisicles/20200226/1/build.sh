...
#  bisicles 20200226: 
#
#    > r3897 | slcornford | 2020-02-26 16:18:02 +0000 (Wed, 26 Feb 2020) | 1 line
#    >
#    > make a first order thing second
#
#  chombo 3.2.patch8:
# 
...
function build_bisicles() {
  ...
  if [ ! -e ${BISICLES_HOME}/BISICLES ] ; then
    ...
    # extract!:
    tar xzf ${SRC_DIR}/bisicles-20200226.tar.gz \
      -C ${BISICLES_HOME}
    \mv ${BISICLES_HOME}/bisicles-20200226 \
...
do
  ...
  do
    ...
    if [ ! -e ${INSTALL_DIR}/petsc/lib/libpetsc.so ] ; then
      ...
      # set up build dir:
      cd ${BUILD_DIR}
      rm -fr ${BUILD_DIR}/petsc-3.12.4
      # extract source:
      tar xzf ${SRC_DIR}/petsc-lite-3.12.4.tar.gz
      cd petsc-3.12.4
      # configure and build:
      ./configure \
        ...
        --with-ssl=0  && \
        make -j8 \
        PETSC_DIR=${BUILD_DIR}/petsc-3.12.4 \
