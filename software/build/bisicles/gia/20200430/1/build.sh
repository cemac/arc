...
# this version of the code has been patched from the BISICLES trunk, commit:
#
#    > r3919 | dmartin | 2020-04-29 21:17:15 +0100 (Wed, 29 Apr 2020) | 3 lines
#    >
#    > adding Dan's "hardest-possible-way-to-do-this" approach to setting sectors.
#
...
function build_bisicles() {
  ...
  if [ ! -e ${BISICLES_HOME}/BISICLES ] ; then
    ...
    # extract!:
    tar xzf ${SRC_DIR}/bisicles-20200430.tar.gz \
      -C ${BISICLES_HOME}
    \mv ${BISICLES_HOME}/bisicles-20200430 \
