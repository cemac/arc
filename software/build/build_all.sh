...
# xios 20220707:
cd ${CEMAC_SOFTWARE}/build/xios/20220707/2 && build
# atlas 3.10.3:
cd ${CEMAC_SOFTWARE}/build/atlas/3.10.3/3 && build
# fluidity 4.1.20:
...
# eccodes 2.35.0:
cd ${CEMAC_SOFTWARE}/build/eccodes/2.35.0/2 && build
# eccodes 2.44.0:
cd ${CEMAC_SOFTWARE}/build/eccodes/2.44.0/2 && build
# cmaq 20250825:
