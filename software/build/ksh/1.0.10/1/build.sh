...
# get sources:
get_file "https://github.com/ksh93/${APP_NAME}/archive/refs/tags/v${APP_VERSION}.tar.gz" ${APP_NAME}-${APP_VERSION}.tar.gz
...
if [ ! -e ${INSTALL_DIR}/bin/ksh ] ; then
  ...
  cd ${APP_NAME}-${APP_VERSION} && \
    ./bin/package make && \
    ./bin/package install ${INSTALL_DIR}
   # set rpath:
   patchelf --set-rpath ${INSTALL_DIR}/lib ${INSTALL_DIR}/bin/ksh
   patchelf --set-rpath ${INSTALL_DIR}/lib ${INSTALL_DIR}/bin/shcomp
fi
