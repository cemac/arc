...
# get sources:
get_file "https://developer.download.nvidia.com/hpc-sdk/${APP_VERSION}/${APP_NAME}_2023_2311_Linux_x86_64_cuda_12.3.tar.gz"
...
if [ ! -e ${INSTALL_DIR}/compilers/bin/nvfortran ] ; then
  ...
  # set up build dir:
  cd ${BUILD_DIR} && \
  rm -fr ./${APP_NAME}_2023_2311_Linux_x86_64_cuda_12.3
  # extract and run installer:
  tar xzf ${SRC_DIR}/${APP_NAME}_2023_2311_Linux_x86_64_cuda_12.3.tar.gz
  cd ${APP_NAME}_2023_2311_Linux_x86_64_cuda_12.3/install_components
  NVHPC_SILENT=true \
