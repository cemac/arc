...
CONDA_PACKAGES="cartopy cdsapi cf_units genshi geopandas geopy ipython iris matplotlib netcdf4 nose notebook numpy obspy pandas paramiko pylint pyproj pyqt pyresample python-eccodes requests scipy shapely spyder wrf-python xarray"
# pip packages to add:
PIP_PACKAGES=""
